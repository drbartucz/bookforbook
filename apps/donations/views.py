...
class DonationListCreateView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            logger.exception('Failed to notify institution of donation offer %s', donation.pk)
    ...
    def post(self, request, pk):
        ...
        with transaction.atomic():
            ...
            try:
                ...
                logger.exception('Failed to notify donor of donation acceptance %s', donation.pk)
...
class DonationDeclineView(APIView):
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            logger.exception('Failed to notify donor of donation decline %s', donation.pk)
