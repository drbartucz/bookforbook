...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    avg_recent_rating = models.DecimalField(max_digits=3, decimal_places=2, null=True, blank=True)
    ...
    def is_institutional(self):
        return self.account_type in (self.AccountType.LIBRARY, self.AccountType.BOOKSTORE)
