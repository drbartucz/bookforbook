    ...
    <div className={styles.page}>
      ...
      <div className={`card ${styles.profileCard}`}>
        ...
        <div className={styles.profileInfo}>
          ...
          {(profile.account_type === 'library' || profile.account_type === 'bookstore') && profile.institution_url && (
            <a href={profile.institution_url} target="_blank" rel="noopener noreferrer" className={styles.institutionUrl}>
              <svg viewBox="0 0 20 20" fill="currentColor" width="14" height="14">
                <path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z" />
                <path d="M5 5a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-3a1 1 0 10-2 0v3H5V7h3a1 1 0 000-2H5z" />
              </svg>
              {profile.institution_url}
            </a>
          )}
          {(profile.account_type === 'library' || profile.account_type === 'bookstore') && profile.institution_about && (
            <p className={styles.institutionAbout}>{profile.institution_about}</p>
          )}
          {(profile.account_type === 'library' || profile.account_type === 'bookstore') && profile.institution_bookshop_url && (
            <a href={profile.institution_bookshop_url} target="_blank" rel="noopener noreferrer" className={styles.institutionUrl}>
              <svg viewBox="0 0 20 20" fill="currentColor" width="14" height="14">
                <path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z" />
                <path d="M5 5a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-3a1 1 0 10-2 0v3H5V7h3a1 1 0 000-2H5z" />
              </svg>
              Bookshop.org wishlist
            </a>
          )}
        </div>
